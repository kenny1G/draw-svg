...
public:
  ...
  // Set pixel buffer
  virtual void set_pixel_buffer(unsigned char *pixel_buffer, size_t width,
                                size_t height) = 0;
...
public:
  ...
  // set pixel buffer
  void set_pixel_buffer(unsigned char *pixel_buffer, size_t width,
                        size_t height);
...
private:
  ...
  void rasterize_ellipse(double cx, double cy, double rx, double ry,
